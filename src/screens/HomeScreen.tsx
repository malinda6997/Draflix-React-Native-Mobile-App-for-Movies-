      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <HorizontalMovieScroll
          ...
          onSeeMore={() =>
            router.push({
              pathname: "/category",
              params: { name: "Latest movies", type: "trending" },
            } as any)
          }
        />
        ...
        <HorizontalMovieScroll
          ...
          onSeeMore={() =>
            router.push({
              pathname: "/category",
              params: { name: "Trending Now", type: "action" },
            } as any)
          }
        />
        ...
        <HorizontalMovieScroll
          ...
          onSeeMore={() =>
            router.push({
              pathname: "/category",
              params: { name: "Comedy Pick", type: "comedy" },
            } as any)
          }
        />
        ...
        <HorizontalMovieScroll
          ...
          onSeeMore={() =>
            router.push({
              pathname: "/category",
              params: { name: "Drama Series", type: "drama" },
            } as any)
          }
        />
        ...
        <HorizontalMovieScroll
          ...
          onSeeMore={() =>
            router.push({
              pathname: "/category",
              params: { name: "Top Rated", type: "topRated" },
            } as any)
          }
        />
      </ScrollView>
